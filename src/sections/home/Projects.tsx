...
const ProjectCard = ({
  ...
  return (
    <div className="sm:p-4 group w-full border-dashed sm:border-2 border-transparent text-neutral-600 dark:text-neutral-400 dark:sm:hover:bg-neutral-950 sm:hover:bg-neutral-100">
